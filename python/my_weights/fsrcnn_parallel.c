...
int main(int argc, char *argv[])
{
	...
	weights_layer1_ptr = fopen("weights_layer1_finetuned.txt", "r");
	...
	biases_layer1_ptr = fopen("biasess_layer1_finetuned.txt", "r");
    ...
    weights_layer2_ptr = fopen("weights_layer2_finetuned.txt", "r");
	...
	biases_layer2_ptr = fopen("biasess_layer2_finetuned.txt", "r");
	...
	weights_layer3_ptr = fopen("weights_layer3_finetuned.txt", "r");
	...
	biases_layer3_ptr = fopen("biasess_layer3_finetuned.txt", "r");
	...
	weights_layer4_ptr = fopen("weights_layer4_finetuned.txt", "r");
	...
	biases_layer4_ptr = fopen("biasess_layer4_finetuned.txt", "r");
	...
	weights_layer5_ptr = fopen("weights_layer5_finetuned.txt", "r");
	...
	biases_layer5_ptr = fopen("biasess_layer5_finetuned.txt", "r");
	...
	weights_layer6_ptr = fopen("weights_layer6_finetuned.txt", "r");
	...
	biases_layer6_ptr = fopen("biasess_layer6_finetuned.txt", "r");
    ...
    weights_layer7_ptr = fopen("weights_layer7_finetuned.txt", "r");
	...
	biases_layer7_ptr = fopen("biasess_layer7_finetuned.txt", "r");
	...
	weights_layer8_ptr = fopen("weights_layer8_finetuned.txt", "r");
	...
	biases_layer8_ptr = fopen("biasess_layer8_finetuned.txt", "r");
